...
public class Counter extends Actor
{
    ...
    private Color pilihanwarnaText;
    ...
    public Counter(String warnaText, String nama){
        setImage(nama);
        background = getImage();  // get image from class
        value = 0;
        target = 0;
    ...
    private void updateImage()
    {
        ...
        if("WHITE".equals(warnaText)){
            pilihanwarnaText = Color.WHITE;
        } else{
            pilihanwarnaText = Color.BLACK;
        }
    
        GreenfootImage text = new GreenfootImage(prefix + value, 22, pilihanwarnaText, transparent) ;
